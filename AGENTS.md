...
AI agents may participate as disclosed contributors. Native agent participation is an intended project capability, but authority remains scoped and auditable.

Every agent contribution must identify:

- the agent;
- accountable individual or organization sponsor;
- operator/controller when different;
- material models, tools, and external providers;
