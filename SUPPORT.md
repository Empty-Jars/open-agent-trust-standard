...
This repository develops an open standard and supporting materials. It does not provide production hosting, emergency response, legal advice, certification, or guarantees about any AI agent.
...
Maintainers may clarify repository process, confirm whether a proposal is in scope, direct work to an existing issue, review evidence, or identify required specialist and human-accountability checkpoints. Acceptance, conformance, deployment approval, institutional endorsement, payment, or future support is never implied by a response.

See [CONTRIBUTING.md](CONTRIBUTING.md) and [docs/ISSUE-LIFECYCLE.md](docs/ISSUE-LIFECYCLE.md) before beginning substantial work.
